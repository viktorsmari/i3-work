...
sudo apt-get install pwgen curl nmap vim zsh git git-core arandr g++ automake make chromium-browser tree scrot bc traceroute htop whois xclip thunar bmon glipper
